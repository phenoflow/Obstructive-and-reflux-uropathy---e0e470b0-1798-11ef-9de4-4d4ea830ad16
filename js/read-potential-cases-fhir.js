...
(async () => {
  ...
  await fs.writeFile("obstructive-and-reflux-uropathy-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("obstructive-and-reflux-uropathy-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
